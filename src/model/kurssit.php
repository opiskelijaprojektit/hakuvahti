...
function getCourseData($schoolid, $term, $id) {
  ...
  $url = COURSES_URL_COURSEDATA . "?$term-term=$id&school-id=$schoolid&format=json";
 ...
 * 
 * @see https://github.com/pekkatapio/courses/tree/main
 */
function getCourses() {

  # Ladataan kurssien tiedot JSON-muodossa.
  $url_content = file_get_contents(COURSES_URL_COURSES);
