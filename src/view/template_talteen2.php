...
<html lang="fi">
	...
	<body>
		...
		<footer class="footer">
			<div class="position-relative d-inline-flex header__logo">
			...
			<ul class="linkki1">
				<li>
					<a href="https://sasky.fi/sasky/saavutettavuus/" class="">Saavutettavuus </a>
				</li>
				<li>
					<a href="https://sasky.fi/sasky/laskutusosoite/" class="">Laskutusosoite </a>
				</li>

				<li>
					<a href="https://sasky.fi/sasky/palaute/" class="">Palaute </a>
				</li>

				<li>
					<a href="https://sasky.fi/sasky/medialle/uutiskirjeet/" class="">Uutiskirjeet </a>
				</li>

				<li>
					<a href="https://sasky.fi/sasky/yhteystiedot/" class="">Henkilöstön yhteystiedot </a>
				</li>
			</ul>
			<ul class="linkki2">
				<li>
					<a href="https://sasky.fi/koulutukset/" class="">Koulutukset </a>
				</li>
				<li>
					<a href="https://sasky.fi/hakijalle/hakija-ja-uraohjauspalvelu/" class="">Sasky Avain </a>
				</li>

				<li>
					<a href="https://sasky.fi/oppilaitokset/" class="">Oppilaitokset </a>
				</li>

				<li>
					<a href="https://sasky.fi/hakijalle/" class="">Hakijalle </a>
				</li>

				<li>
					<a href="https://sasky.fi/palvelut/" class="">Palvelut </a>
				</li>			
			</ul>

			<ul class="linkki3">
				<li>
					<a href="https://sasky.fi/sasky/saavutettavuus/" class="">Wilma ammatillinen </a>
				</li>
				<li>
					<a href="https://sasky.fi/sasky/saavutettavuus/" class="">Wilma lukio</a>
				</li>

				<li>
					<a href="https://sasky.fi/sasky/saavutettavuus/" class="">Moodle </a>
				</li>

				<li>
					<a href="https://sasky.fi/sasky/saavutettavuus/" class="">Microsoft 365</a>
				</li>

				<li>
					<a href="https://sasky.fi/sasky/saavutettavuus/" class="">Henkilökunnan ja opiskelijoiden sähköposti</a>
				</li>
				<li>
					<a href="https://sasky.fi/sasky/saavutettavuus/" class="">Henkilökunnan Intra</a>
				</li>
				<li>
					<a href="https://sasky.fi/sasky/saavutettavuus/" class="">Matkalaskuohjelma M2</a>
				</li>
			</ul>
