...
<div class="content_box">
  <h2>Lisää haku</h2>
  <div>
    <form class="form_grid" action="" method="POST">
        <h3 class="form_item_1"><label for="hakusana">Haettu sana:</label></h3>
        <input id="hakusana" type="text" name="hakusana" class="form_item_2 input_field">
        <span class="screen-reader-text">
        Suurennuslasi ikoni</span>
        <svg class="form_item_3 icon" xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 17 17" fill="none"><path d="M12.237 7a4.999 4.999 0 10-9.998-.001 4.999 4.999 0 009.998 0zm-.965 5.096A6.498 6.498 0 01.739 7 6.497 6.497 0 017.237.5a6.498 6.498 0 015.096 10.533l4.184 4.184a.75.75 0 01-1.06 1.06l-4.186-4.181z"/></svg>
        <h3 class="form_item_4"><label for="email">Sähköposti:</label></h3>
        <input id="email" type="text" name="email" class="form_item_5 input_field">
        <span class="screen-reader-text">
        Sähköposti ikoni</span>
        <svg class="form_item_6 icon" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="none" height="800px" width="800px" version="1.1" id="Layer_1" viewBox="0 0 64 64" enable-background="new 0 0 64 64" xml:space="preserve">
